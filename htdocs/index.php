...
<div id="RIGHT" class="infoBoxClose">
    <form id="GENERATOR_FORM">
        ...
        <div class="together" id="NUMBERS">
            ...
            <div class="form_input">
                ...
                <input type="number" name="inputNumbers" id="INPUT_NUMBERS" placeholder="1234567890">
            </div>
        </div>
    ...
    <div class="option_present">
        ...
        <button id="CREATE_MORE">MORE</button>
...
<div id="INFO_BOX">
    <div id="INFO_BOX_CLOSE" class="closeButton infoBoxClose">X</div>
...
<?php
    echo "<script>";
    echo preg_replace('/\s+/', " ",file_get_contents(__DIR__ . "/files/js/generate.v2.js"));
    echo preg_replace('/\s+/', " ",file_get_contents(__DIR__."/files/js/functions.js"));
    echo "</script>"
?>
</html>